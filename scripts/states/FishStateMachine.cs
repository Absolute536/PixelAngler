...
public partial class FishStateMachine : StateMachine
{
    public override void _Ready()
    {
        ...
        SignalBus.Instance.AnglingCancelled += TransitionToDefaultState;
        SignalBus.Instance.QTEFailed += TransitionToDefaultState;
        SignalBus.Instance.FishBite += TransitionToDefaultState; // probably can't cuz the biting one will transition as well
    }

    public void TransitionToDefaultState(object sender, EventArgs e)
    {
